...
//        newEntity.setName("Task 2");
//        newEntity.setDescription("Description 2");
//        newEntity.setLastUpdated(new Date());
//        newEntity.setPriority(TaskPriority.MEDIUM);
//        newEntity.setState(TaskState.TODO);
//        newEntity.setUserId(2L);
